...
tweets0 <- get_all_tweets(query = trans_query, 
                          ...
                          file = "data/raw/trans_sports_ban0" # name of the resulting RDS file
)
...
tweets1_a <- get_all_tweets(query = trans_query, 
                          ...
                          bearer_token = bearer_token, # bearer token to access Twitter API 
                          file = "data/raw/trans_sports_ban1a" # name of the resulting RDS file
)
...
tweets1_b <- get_all_tweets(query = trans_query, 
                            ...
                            bearer_token = bearer_token, # bearer token to access Twitter API 
                            file = "data/raw/trans_sports_ban1b" # name of the resulting RDS file
)
...
tweets2 <- get_all_tweets(query = trans_query, 
                          ...
                          bearer_token = bearer_token, # bearer token to access Twitter API 
                          file = "data/raw/trans_sports_ban2" # name of the resulting RDS file
)
...
tweets3 <- get_all_tweets(query = trans_query, 
                          ...
                          bearer_token = bearer_token, # bearer token to access Twitter API 
                          file = "data/raw/trans_sports_ban3" # name of the resulting RDS file
)
